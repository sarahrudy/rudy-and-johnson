    ...
    <section className="about-section">
      <div className="rudy-section">
        ...
        <div className="rudy-bio">
          ...
          <br />
          <p>I have a Bachelor of Science in Business Administration from the University of Mary Washington in Fredericksburg, Virginia. After working in Marketing in the DC area for a few years, I moved to Park City, Utah to live in a quaint mountain town with ski slopes in my backyard. I fell in love with the mountains and downhill skiing, so after a couple seasons working in the signature 5-star restaurant at Montage Deer Valley, I decided to move to Denver in search of a balance for the mountain life and more career opportunities. When I got to Denver, I was hired at an oil & gas company where I was promoted quickly from Office Coodinator, to Land Technician, to Title Examiner, then Landman Associate. As a Landman Associate, I helped manage a team of brokers, built relationships with owners, negotiated oil & gas contracts, and helped facilitate the acquisition of land for exploration and development. When Covid hit, I had a fortunate opportunity to switch to a more sustainable industry. I've always been inspired by technology and how it's changing the world we live in, so I decided to go to Turing to learn how to work with multiple technologies and build applications from the ground up.</p>
          <br />
